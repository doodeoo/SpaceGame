...
{
    public class EnemyParticleEngine
    {
        private Random r;
        ...
        public EnemyParticleEngine(List<Texture2D> textures, Vector2 location)
        {
        ...
        private Particle GenerateNewParticle()
        {
            ...
            Vector2 velocity = new Vector2(
                                    0f * (float)(r.NextDouble() * 2 - 1),
                                    -1f * (float)(r.NextDouble() * 5 + 5));
            float angle = 0;
            float angularVelocity = 0f*0.1f * (float)(r.NextDouble() * 2 - 1);
